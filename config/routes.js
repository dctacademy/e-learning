...
const authorssController = require('../app/controllers/authorsController')
...
router.get('/authors', authenticateUser, authorssController.list)
router.post('/authors', authenticateUser,authorizeUser, authorssController.create)
router.get('/authors/:id', authenticateUser, authorssController.show)
router.put('/authors/:id', authenticateUser,authorizeUser, authorssController.update)
router.delete('/authors/:id', authenticateUser, authorssController.destory)

router.get('/categories', categoriesController.list)
router.post('/categories', authenticateUser,authorizeUser,authorizeUser, categoriesController.create)
...
router.post('/courses', authenticateStudent,authorizeUser, coursesController.create)
